...
def main():
    ...
    os.system("gcc -Wno-return-type -fprofile-arcs -ftest-coverage -g -o printtokens2 printtokens2.c")
    os.system("clear")
    testSuites = [
        "randomP.txt",
        "branchRandomP.txt",
    ...
    os.system("clear")
    os.system("rm printtokens2")
    os.system("rm printtokens2.gcda")
    os.system("rm output.txt")
        
def versionTester(testSuite):
    
    with open(testSuite, 'r', encoding='latin-1') as file:
    ...
    for line in lines:
        ...
        if line.endswith("\n"):
            line = line[:-1]
        command = "./printtokens2 " + line + " > " + "output.txt"
        os.system(command)
        # Clear screen
        os.system("clear")
        with open('output.txt', 'r', encoding='latin-1') as file:
    ...
    for folder in tcasFolders:
        ...
        compileCommand = "gcc -o prior" + folder + " " + folder + "/printtokens2.c"
        ...
        testArr.append((folder, len(versionOutput)))
