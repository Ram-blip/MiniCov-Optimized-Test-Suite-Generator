...
def main():
    ...
    os.system("gcc -Wno-return-type -fprofile-arcs -ftest-coverage -g -o schedule schedule.c")
    os.system("clear")
    testSuites = [
        "randomP.txt",
        "branchRandomP.txt",
...
def versionTester(testSuite):
    ...
    for line in lines:
        ...
        if line.endswith("\n"):
            line = line[:-1]
        command = "./schedule " + line + " > " + "output.txt"
        os.system(command)
        # Clear screen
        os.system("clear")
    ...
    for folder in tcasFolders:
        ...
        compileCommand = "gcc -o prior" + folder + " " + folder + "/schedule.c"
