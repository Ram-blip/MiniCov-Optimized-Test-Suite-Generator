...
def main():
    ...
    os.system("gcc -Wno-return-type -fprofile-arcs -ftest-coverage -g -o replace replace.c")
    os.system("clear")
    testSuites = [
        "randomP.txt",
        "branchRandomP.txt",
    ...
    os.system("clear")
    os.system("rm replace")
    os.system("rm replace.gcda")
...
def versionTester(testSuite):
    ...
    for line in lines:
        ...
        if line.endswith("\n"):
            line = line[:-1]
        command = "./replace " + line + " > " + "output.txt"
        os.system(command)
        # Clear screen
        os.system("clear")
    ...
    for folder in tcasFolders:
        ...
        compileCommand = "gcc -o prior" + folder + " " + folder + "/replace.c"
